class CoffeeScene {
    ...
    createScene() {
        ...
        // players
        let spawnPoint1 = new BABYLON.Vector3(mugPosition.x-0.4, mugPosition.y + 1.7, mugPosition.z);
        let spawnPoint2 = new BABYLON.Vector3(mugPosition.x+0.4, mugPosition.y + 1.7, mugPosition.z);
